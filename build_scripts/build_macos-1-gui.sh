...
# This script builds the GUI from the chia-blockchain-gui repo
# Unlike the original in chia-blockchain, we don't need to update submodules
# since we ARE the GUI repo
...
# Other than `packages/gui`, all other packages are no longer necessary after build.
